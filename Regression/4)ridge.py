...
def poly_ridge_regression(data, deg, l2_penalty):
    model = turicreate.linear_regression.create(poly_feat(data, deg), target='Y', l2_penalty=l2_penalty, validation_set=None, verbose=False)
    return model
...
for l2_penalty in [1e-25, 1e-10, 1e-6,1e-3, 1e2]:
    m = poly_ridge_regression(data, deg=16, l2_penalty=l2_penalty)
